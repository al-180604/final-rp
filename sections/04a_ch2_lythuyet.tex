...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{Images/Star_topology.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{Images/Mesh_topology.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{Images/Tree_topology.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{Images/Cluster_binding.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/Mqtt_broker_archi.drawio.png}
